...
export const DEV_SCENARIO: WeightScenario = 'normal';
// ─────────────────────────────────────────────────────────────────────────────

const w = (n: number) => format(subWeeks(new Date(), n), 'yyyy-MM-dd');

// ── Scenario: normal (steady loss) ───────────────────────────────────────────
export const mockWeightEntriesNormal = [
...
export const mockWeightEntriesPlateau = [
...
export const mockWeightEntriesGained = [
...
// ── Scenario: new user ────────────────────────────────────────────────────────
export const mockWeightEntriesNewUser: typeof mockWeightEntriesNormal = [];
...
export const mockLogRows = mockWeightEntries
  .slice()
...
export const mockProjectionEntries = (() => {
  const result = [];
